angular.module('App').controller('editar_usuariosCtrl', ['$scope', '$rootScope','$http', 'MyService', function ($scope, $rootScope,$http,MyService) {
    console.log("WOOW "+MyService.data.rut_usuario);
    $scope.rol_disponible=true;
    $scope.config=false;
